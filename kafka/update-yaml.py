...
def update_policy(encoded_policy: str) -> str:
    """
...
def parse_and_update(file_path: str) -> str:
    """
    ...
    for doc in docs:
        ...
        if doc.get("kind") == "Pod":
            ...
            if old_policy:
                new_base64 = update_policy(old_policy)
...
if __name__ == "__main__":
    ...
    new_policy = parse_and_update(args.file)
